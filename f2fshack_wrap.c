...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__f2fshack

#else
#  define SWIG_init    init_f2fshack

#endif
#define SWIG_name    "_f2fshack"
...
SWIGINTERN PyObject *_wrap_open_device(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "open_device" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  result = (int)open_device(arg1);
  resultobj = SWIG_From_int((int)(result));
...
SWIGINTERN PyObject *_wrap_dedup_one_finger(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  int *arg2 = (int *) 0 ;
  int *arg3 = (int *) 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "dedup_one_finger", 4, 4, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "dedup_one_finger" "', argument " "1"" of type '" "int *""'"); 
  }
  arg1 = (int *)(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "dedup_one_finger" "', argument " "2"" of type '" "int *""'"); 
  }
  arg2 = (int *)(argp2);
  res3 = SWIG_ConvertPtr(swig_obj[2], &argp3,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "dedup_one_finger" "', argument " "3"" of type '" "int *""'"); 
  }
  arg3 = (int *)(argp3);
  ecode4 = SWIG_AsVal_int(swig_obj[3], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "dedup_one_finger" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  result = (int)dedup_one_finger(arg1,arg2,arg3,arg4);
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_close_with_sync(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args, "close_with_sync", 0, 0, 0)) SWIG_fail;
  close_with_sync();
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "open_device", _wrap_open_device, METH_O, NULL},
	 { "dedup_one_finger", _wrap_dedup_one_finger, METH_VARARGS, NULL},
	 { "close_with_sync", _wrap_close_with_sync, METH_NOARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
